            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                    	...
                    	{{Form::open(array('url'=>'admin/create-promo-codes'))}}
                            <div class="form-group">
                              ...
                              <div class="col-lg-12">
                                ...
                                name="promo_code"
                                tabindex="1"
                                value="" required placeholder="Please Enter Promo Code" />
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-lg-12">
                                <select class="form-control" tabindex="2" id="discount_type" name="discount_type" required>
                                	<option value="" selected="selected" disabled="true">Please Select Discount Type</option>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-lg-12">
                                ...
                                name="promo_discount"
                                tabindex="3"
                                step="1" min="1" value="" required placeholder="Please Enter Promo Discount" />
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-lg-12">
                                ...
                                name="promo_on_rides"
                                tabindex="3"
                                step="1" min="0" value="" required placeholder="Please Enter Promotion on Rides" />
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              <center>
                                <button tabindex="6" type="submit" name="submit" class="btn btn-success">Create</button>
                              </center>
                            </div>
                          {{Form::close()}}
