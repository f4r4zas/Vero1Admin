	...
	<div class="navbar navbar-expand-md navbar-dark">
		<div class="navbar-brand">
			<a href="{{env('APP_URL')}}" class="d-inline-block">
				<img src="http://184.72.97.15/vero/images/ver-logo.png" alt="">
			</a>
		</div>
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-content wmin-md-300">
						...
						<div class="dropdown-content-body dropdown-scrollable">
							<ul class="media-list">
								<li class="media">
									<div class="mr-3">
										<img src="{{ asset('public/assets/global_assets/images/placeholders/placeholder.jpg') }}" width="36" height="36" class="rounded-circle" alt="">
									</div>
									<div class="media-body">
