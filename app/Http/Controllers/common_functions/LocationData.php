...
namespace App\Http\Controllers\common_functions;
...
class LocationData extends Controller
{
    ...
    public function USCities(Request $request){
       ...
       $cities =  $USA[$request->post('state')];
       
       if($cities){
           ?>
           <option value="0">Select a city</option>
           <?php
           foreach($cities as $allCities){
               ?>
               <option value="<?php echo $allCities ?>"><?php echo $allCities ?></option>
               <?php
           }
       }else{
           ?>
